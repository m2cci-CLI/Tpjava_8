...
public class Optional_01_Test {
    ...
    Predicate<Person> supdix =p->p.getAge()==10 ;
    Predicate<Person> egaquatre =p-> p.getAge()==400  ;
    Predicate<Person> supfirst =p->(p.getFirstname().equals("last_10")) && (p.getAge()==10) ;
    ...
    public void test_optional_found() throws Exception {
        ...
        // TODO age == 10
        Optional<Person> result = Optional.of(find(personList,supdix));
    ...
    public void test_optional_notfound() throws Exception {
        ...
        // TODO invoquer la méthode find(List<T> list, Predicate<T> predicate)
        // TODO age == 400
        Optional<Person> result =  Optional.ofNullable(find(personList,egaquatre));
    ...
    public void test_optional_notfound_throw_exception() throws Exception {
        ...
        Optional<Person> result = Optional.ofNullable(find(personList,supfirst));
    ...
    public void test_optional_notfound_with_default_value() throws Exception {
        ...
        Optional<Person> optPerson = Optional.ofNullable(find(personList,egaquatre));
